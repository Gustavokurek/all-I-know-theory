...
/***/ "./src/A019-exercicio/formValidator.ts":
/*!*********************************************!*\
  !*** ./src/A019-exercicio/formValidator.ts ***!
  \*********************************************/
...
form.addEventListener('submit', function (e) {
    ...
    if (checkErrorsToSend(this))
        form.submit();
});
function checkEmptyField(...campos) {
    campos.forEach((campo) => {
        if (!campo.value)
            showErrorMessage(campo, 'campo obrigatório');
    });
}
...
function checkErrorsToSend(form) {
    let send = true;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./formValidator */ "./src/A019-exercicio/formValidator.ts");
